...
class ReservableByStaffsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create reservable_by_staff" do
    assert_difference('ReservableByStaff.count') do
      post reservable_by_staffs_url, params: { reservable_by_staff: { end_time: @reservable_by_staff.end_time, filled_flag: @reservable_by_staff.filled_flag, staff_id: @reservable_by_staff.staff_id, start_time: @reservable_by_staff.start_time, the_date: @reservable_by_staff.the_date } }
    end
  ...
  test "should update reservable_by_staff" do
    patch reservable_by_staff_url(@reservable_by_staff), params: { reservable_by_staff: { end_time: @reservable_by_staff.end_time, filled_flag: @reservable_by_staff.filled_flag, staff_id: @reservable_by_staff.staff_id, start_time: @reservable_by_staff.start_time, the_date: @reservable_by_staff.the_date } }
